      ...
      <section class=" hero-section position-relative overflow-hidden mb-0 mb-lg-11">
        ...
        <div class="container ">
          <div class="row align-items-center">
            <div class="col-xl-6">
              <div class="hero-content  my-1 my-xl-0 my-xl-text-secondary"><i class="ti ti-rocket text-secondary fs-6"></i>
                @foreach ($data as $dt)
                
                <h1 class="fw-bolder mb-4 fs-13" data-aos="fade-up" data-aos-delay="400" data-aos-duration="1000">
                    <span class="text-primary ">{{$dt->heading_1}} <P style="font-size: 12px">{{$dt->sub_heading}}</P> </span>{{$dt->heading_2}}
                </h1>

                @endforeach
                <h6 class="d-flex align-items-center mb-8 text-center gap-2 fs-4 fw-semibold mb-3" data-aos="fade-up"
                  data-aos-delay="200" data-aos-duration="1000">{{$dt->selogan}}
                </h6>
                <div class="d-sm-flex align-items-center gap-3 mb-6" data-aos="fade-up" data-aos-delay="800"
                  data-aos-duration="1000">
                  <a class="btn btn-primary btn-hover-shadow d-block mb-3 mb-sm-0 scroll-link"
                    href="#bootstrap-demos">Read More</a>
                  <a class="btn btn-light d-block scroll-link" href="#react-demos">Lapor Insident</a>
                </div>
                <div class="d-sm-flex align-items-center text-primary gap-3 mb-4" data-aos="fade-up" data-aos-delay="1000"
                  data-aos-duration="1000">
              ...
              <div class="row justify-content-center">
                <div class="col-sm-6 col-lg-4 mb-8">
                  <div class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                    <img src="dist/images/demos/demo-main.jpg" alt="" class="img-fluid">
                    <a target="_blank" href="https://demos.adminmart.com/premium/bootstrap/modernize-bootstrap/package/html/main/index.html"
                      class="btn btn-primary lp-demos-btn fs-3 px-7 py-1 rounded position-absolute top-50 start-50 translate-middle">Read More</a>
                  </div>
                  <h6 class="mb-0 text-center fs-3">Main</h6>
                </div>
                <div class="col-sm-6 col-lg-4 mb-8">
                  <div class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                    <img src="dist/images/demos/demo-dark.jpg" alt="" class="img-fluid">
                ...
                <div class="col-sm-6 col-lg-4 mb-8">
                  <div class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                    <img src="dist/images/demos/demo-horizontal.jpg" alt="" class="img-fluid">
                ...
                <div class="col-sm-6 col-lg-4 mb-8">
                  <div class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                    <img src="dist/images/demos/demo-minisidebar.jpg" alt="" class="img-fluid">
                ...
                <div class="col-sm-6 col-lg-4 mb-8">
                  <div class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                    <img src="dist/images/demos/demo-rtl.jpg" alt="" class="img-fluid">
          ...
          <div class="row justify-content-center">
            <div class="col-lg-8">
              <h2 class="fs-9 text-center mb-4 mb-lg-5 fw-bolder" data-aos="fade-up" data-aos-delay="200"
                data-aos-duration="1000">Berita Terkini</h2>
            </div>
          </div>
                    ...
                    <div class="d-flex justify-content-between mb-4">
                      ...
                      <div>
                        <ul class="list-unstyled d-flex align-items-center justify-content-end gap-1 mb-0">
                          <li>
                            <a href="#">
                              <img src="dist/images/svgs/icon-star.svg" alt="" class="img-fluid">
                            </a>
                          </li>
                          <li>
                            <a href="#">
